...
export async function processLaunchRun(runId) {
    ...
    await createInitialFinding({
        ...
        summary: 'Limen has captured the page HTML, resolved the final URL, and stored the first evidence snapshot with core launch signals.',
        recommendation: 'Continue the pipeline with screenshot capture, richer extraction, and audience-specific analysis.',
    });
