...
export type HeuristicFinding = {
  ...
  launchDimension: 'clarity' | 'trust' | 'cta' | 'channel';
  /** Which captured signal this rule actually inspected, for a real evidence ref. */
  evidenceField: string;
  evidenceExcerpt: string | null;
};

export async function createHeuristicFindings(input: HeuristicInput): Promise<HeuristicFinding[]> {
